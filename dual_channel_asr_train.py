...
from data.dual_channel_datamodule import DualAsrWavDataModule, DualAsrFbankDataModule
...
from model.dual_model import DualAsrModelFbank
from model.dual_model_wav import DualAsrModelWav
...
from utils.checkpoint import save_checkpoint as save_checkpoint_impl
from utils.checkpoint import (
    save_checkpoint_with_global_batch_idx,
    update_averaged_model,
)
from utils.dist import cleanup_dist, setup_dist
from utils.env import get_env_info
from utils.hooks import register_inf_check_hooks
...
LRSchedulerType = Union[torch.optim.lr_scheduler._LRScheduler, model.optim.LRScheduler]
...
def compute_loss(
    ...
    dialogue_state_labels = batch["dialogue_state_labels"]
...
def run(rank, world_size, args):
    ...
    def remove_short_and_long_utt(c: Cut):
        ...
        return True
    if params.use_raw_wav:
        reazonspeech_corpus = DualAsrWavDataModule(args)
    else:
        reazonspeech_corpus = DualAsrFbankDataModule(args)
...
def main():
    ...
    DualAsrWavDataModule.add_arguments(parser)
